...
#define MPU6050_DLPF_CONFIG                 (MPU6050_DLPF_CFG_42HZ)

/* MPU6050 FIFO setting */
#define MPU6050_IS_FIFO_EN                  0

/* MPU6050 FIFO sampling rate, unit: Hz */
#define MPU6050_FIFO_SAMPLE_RATE            1000
 ...
 */
#define MPU6050_SAMPLE_SOURCE_FREQ          1000    /* 1 KHz, because the DLPF is enabled */

/* MPU6050 FIFO sampling setting, (N KHz / M Hz) - 1 */
#define MPU6050_FIFO_SAMPLE_SETTING         ((MPU6050_SAMPLE_SOURCE_FREQ / MPU6050_FIFO_SAMPLE_RATE) - 1)
...
enum MPU6050_DLPF_CFG_VALUE{
    MPU6050_DLPF_CFG_256HZ                  = 0x00, /* 8 Fs (kHz). */
    MPU6050_DLPF_CFG_188HZ                  = 0x01, /* 1 Fs (kHz). */
    MPU6050_DLPF_CFG_98HZ                   = 0x02, /* 1 Fs (kHz). */
    MPU6050_DLPF_CFG_42HZ                   = 0x03, /* 1 Fs (kHz). */
    MPU6050_DLPF_CFG_20HZ                   = 0x04, /* 1 Fs (kHz). */
    MPU6050_DLPF_CFG_10HZ                   = 0x05, /* 1 Fs (kHz). */
    MPU6050_DLPF_CFG_5HZ                    = 0x06, /* 1 Fs (kHz). */
    MPU6050_DLPF_CFG_RESERVED               = 0x07, /* 8 Fs (kHz). */
};
